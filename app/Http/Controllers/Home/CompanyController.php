...
//        }
    ...
    public function update(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'Company.taxpayer_number'    => 'max:255',
            'Company.bank'               => 'max:255',
            'Company.bank_account'       => 'max:255',
            'Company.invoice_tel'        => 'max:255',
            ...
            'Company.taxpayer_number'    => '纳税人识别号',
            'Company.bank'               => '开户银行',
            'Company.bank_account'       => '银行账号',
            'Company.invoice_tel'        => '发票联系电话',
