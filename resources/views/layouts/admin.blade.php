...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    @section('menu')
    <ul class="nav menu">
        <li class="{{ Request::getPathInfo() == '/admin/index' ? 'active' : '' }}"><a href="{{ url('admin/index') }}"><span class="glyphicon glyphicon-dashboard"></span>
                Dashboard</a></li>
        <li class="{{ Request::getPathInfo() == '/admin/widgets' ? 'active' : '' }}"><a href="widgets.html"><span class="glyphicon glyphicon-th"></span> Widgets</a></li>
        <li class="{{ Request::getPathInfo() == '/admin/charts' ? 'active' : '' }}"><a href="charts.html"><span class="glyphicon glyphicon-stats"></span> Charts</a></li>
        <li class="parent ">
            <a href="#">
