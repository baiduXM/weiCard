                ...
                @else
                    @foreach($links as $item)
                        <tr class="{{ $item->user_id == Auth::id() ? 'info' : '' }}">
                            ...
                            @if($item->default_link=='phone'||$item->default_link=='cardcase'||$item->default_link=='follow'||$item->default_link=='invoice'||$item->default_link=='message')
                                <td class="b-td-width b-td-hide"style="color: red;">系统栏目只可编辑顺序</td>
                            @else
                            ...
                            <td class="b-td-icon b-td-hide w-icon">
                                ...
                                @if(Auth::user()->company)
                                    @if($item->default_link=='phone'||$item->default_link=='cardcase'||$item->default_link=='follow'||$item->default_link=='invoice'||$item->default_link=='message')
                                        <a href="" data-toggle="modal" data-target="#modal-employee-edit2"
                                           data-url="{{ url('company/link/'.$item->id) }}" class="operate-edit2"><i
                                                    class="iconFont">&#xe632;</i></a>
                                    @else
...
@section('modal-extend')
                ...
                <form action="{{ url('company/link') }}" method="post" class="form-create"
                    ...
                    <div class="modal-body">
                        <div class="modal-address">
                            ...
                            <p>
                                <span>序号 : </span>
                                <input type="text" name="Link[sort]" placeholder=""
                                       value="{{ old('Link.sort') ? old('Link.sort') : '999' }}">
                ...
                <form action="" method="post" class="form-update"
                    ...
                    <div class="modal-body">
                        <div class="modal-address">
                            ...
                            <p>
                                <span>序号 : </span>
                                <input type="text" name="Link[sort]" placeholder="" class="info-sort"
                                       value="{{ old('Link.sort') ? old('Link.sort') : '' }}">
                                <span class="error-sort" style="color: red;"></span>
                            </p>
                            {{--<p>--}}
                                {{--<span>系统栏目 : </span>--}}
    ...
    <!-- 产品 - 编辑modal2 -->
    <div class="modal fade" id="modal-employee-edit2" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal1 modal2 modal8">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                ...
                <form action="" method="post" class="form-update2"
                      enctype="multipart/form-data">
                    {{--{{ method_field('put') }}--}}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="modal-address">
                            <p>
                                <span>名称 : </span>
                                <input type="text" name="Link[link_name]" placeholder="" class="info-link_name"
                                       value="{{ old('Link.link_name') ? old('Link.link_name') : '' }}" disabled="true">
                                <span class="error-link_name" style="color: red;"></span>
                            </p>
                            {{--<p>--}}
                                {{--<span>网址 : </span>--}}
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary operate-update2">确认</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">返回</button>
                    </div>
                </form>
            </div>
