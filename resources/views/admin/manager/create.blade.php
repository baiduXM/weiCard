        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ url('mpmanager/manager') }}" method="post"
                        ...
                        <div class="form-group">
                            <div class="col-md-12 widget-left">
                                ...
                                <a href="{{ url()->previous() == url()->current() ? url('mpmanager/employee') : url()->previous() }}" type="button" role="button"
