            ...
            <form action="{{ url('user') }}" method="post" enctype="multipart/form-data">
                ...
                <span>微信二维码：
                    ...
                    @else
                        未上传
                    @endif
                    <a href="{{ url('user/qrcode') }}"id="qrcode" class="inputt" ><strong style="background: #23deff;padding: 0 10px; border-radius: 0.3rem; color: #ffffff; line-height: 1.2rem; height: 1.2rem; margin:0.1rem 0;margin-right: 7px;">编辑</strong></a>
