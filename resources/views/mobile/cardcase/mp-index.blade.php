...
<div class="mp-content">
    ...
    <div class="mp-group">
                    ...
                    <div class="accordion-content">
                        <div class="group-list">
                            ...
                            <ul class="group-list-btn">
                                <li class="lt"><a href="javascript:"><i class="iconfont">&#xe639;</i><span>查看</span></a></li>
                                <li class="lt"><a href="javascript:"><i class="iconfont">&#xe644;</i><span>拨号</span></a></li>
                                <li class="lt" data-am-modal="{target: '#mp-btn5'}"><a href="javascript:"><i class="iconfont">&#xe694;</i><span>分组</span></a></li>
                                <li class="lt"><a href="javascript:"><i class="iconfont">&#xe609;</i><span>取消</span></a></li>
                            </ul>
                        </div>
                        <div class="group-list">
                            <div class="group-list-mes">
        ...
        <div class="mp-groupBg"><a href="javascript:"><img src="images/4_03.png" alt=""><span>尚未编建分组</span></a></div>
    </div>
</div>
